...
export default {
  ...
  segmentActiveBackgroundColor: color.brandPrimary,
  segmentTextColor: platform === '#ededed',
  ...
  toolbarDefaultBg: platform === 'ios' ? this.brandDark : this.brandDark,
  toolbarHeight: platform === 'ios' ? (isIphoneX ? 88 : 48) : 56,
